...
<a href={`/${name}/status/${tweetId}`} class="w-full p-2 border-y border-gray-700 h-auto flex pb-2">
   <div class="flex flex-col items-start h-full w-[40px]">
        <img src={profilePic} alt=" who fucking cares" class="w-[40px] rounded-full">
